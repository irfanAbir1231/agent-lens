...
* *For more details, see the full [Data and Simulation Note](docs/product/data-and-simulation-note.md).*
...
See [Data and Simulation Note](docs/product/data-and-simulation-note.md), [Responsible Design Note](docs/responsible-design/human-review-boundary.md), [System Architecture](docs/architecture/system.md), and [Testing Verification](docs/testing/verification.md).
