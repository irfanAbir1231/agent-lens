  ...
  return (
    <div>
      <div className="flex flex-wrap gap-2">
        <Link href="/cases/CASE-8017" className="inline-flex min-h-10 items-center rounded-md bg-blue-600 px-4 text-sm font-semibold text-white hover:bg-blue-700">Open case workspace</Link>
